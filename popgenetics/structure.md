...
##  2 T-482  Madres     4x        132   132   132   132   141   155   157    NA
##  3 T-483  Madres     4x        132   132   132   132   141   146   157    NA
##  4 T-484  Madres     4x        132   132   132   132   146   151   155    NA
##  5 T-485  Madres     4x        132   132   132   132   141   146    NA    NA
##  6 T-486  Madres     4x        132   134    NA    NA   141   155    NA    NA
##  7 T-487  Madres     4x        128   132   166    NA   141   148   155    NA
##  8 T-488  Madres     4x        132   132   132   132   141   148   155    NA
...
## #   X.9 <int>, X.10 <int>, X.11 <int>, AG13 <int>, X.12 <int>, X.13 <int>,
## #   X.14 <int>, AG23 <int>, X.15 <int>, X.16 <int>, X.17 <int>, AG25 <int>,
## #   X.18 <int>, X.19 <int>, X.20 <int>, AG27 <int>, X.21 <int>, X.22 <int>,
## #   X.23 <int>, AG30 <int>, X.24 <int>, X.25 <int>, X.26 <int>, AG35 <int>,
## #   X.27 <int>, X.28 <int>, X.29 <int>, A2 <int>, X.30 <int>, X.31 <int>, …
```
...
## $ X          <int> 146, 132, 132, 132, 132, 134, 132, 132, 135, 132, 128, 166,…
## $ X.1        <int> NA, 132, 132, 132, 132, NA, 166, 132, NA, NA, 132, NA, 166,…
## $ X.2        <int> NA, 132, 132, 132, 132, NA, NA, 132, NA, NA, 166, NA, NA, N…
...
## $ X.6        <int> 254, 248, 246, 248, 246, 246, 246, 248, 250, 246, 248, 248,…
## $ X.7        <int> NA, 250, 248, 250, 246, 262, 250, NA, NA, 246, 250, NA, NA,…
## $ X.8        <int> NA, NA, NA, 256, 246, NA, NA, NA, NA, 246, 258, NA, NA, NA,…
## $ AG10       <int> 216, 218, 218, 216, 218, 216, 218, 216, 216, 218, 216, 216,…
## $ X.9        <int> 218, 218, 218, 218, 222, 218, 218, 218, 218, 218, 218, 218,…
## $ X.10       <int> NA, 218, 218, NA, NA, NA, 218, NA, NA, 218, 220, NA, 218, N…
## $ X.11       <int> NA, 218, 218, NA, NA, NA, 218, NA, NA, 218, NA, NA, 218, NA…
...
## $ X.15       <int> 360, 356, 358, 358, 358, 358, 358, 358, 358, 356, 358, 358,…
## $ X.16       <int> NA, 356, NA, NA, NA, NA, NA, NA, NA, 356, NA, NA, 356, NA, …
## $ X.17       <int> NA, 356, NA, NA, NA, NA, NA, NA, NA, 356, NA, NA, 356, NA, …
## $ AG25       <int> 93, 93, 93, 93, 93, 99, 99, 93, 93, 99, 93, 93, 91, 93, 93,…
## $ X.18       <int> 93, 105, 99, 99, 93, 101, 105, 99, 103, 101, 93, 101, 93, 1…
## $ X.19       <int> NA, NA, 103, NA, 93, 113, NA, 109, NA, 111, 93, NA, 103, 11…
## $ X.20       <int> NA, NA, NA, NA, 93, NA, NA, NA, NA, 113, 93, NA, NA, NA, NA…
## $ AG27       <int> 101, 101, 101, 101, 101, 101, 101, 101, 101, 101, 101, 101,…
## $ X.21       <int> 101, 103, 103, 101, 103, 101, 101, 101, 101, 101, 101, 101,…
## $ X.22       <int> NA, 105, 105, 101, NA, 101, 101, 101, NA, 101, 101, 101, 10…
## $ X.23       <int> NA, NA, NA, 101, NA, 101, 101, 101, NA, 101, 101, 101, 101,…
## $ AG30       <int> 99, 97, 97, 97, 99, 99, 97, 97, 99, 97, 97, 97, 97, 97, 97,…
## $ X.24       <int> 107, 99, 99, 105, 99, 101, 101, 99, 101, 99, 107, 99, 105, …
## $ X.25       <int> NA, 103, 103, NA, 99, 109, 111, 109, NA, NA, 109, NA, NA, 1…
## $ X.26       <int> NA, NA, NA, NA, 99, NA, 113, NA, NA, NA, 113, NA, NA, 109, …
...
## $ X.30       <int> 142, 142, 142, 142, 142, 142, 142, 142, 142, 142, 142, 146,…
## $ X.31       <int> NA, 142, 142, NA, 142, 142, 142, 142, NA, 142, 142, NA, 142…
## $ X.32       <int> NA, 142, 142, NA, 142, 142, 142, 142, NA, 142, 142, NA, 142…
## $ A22        <int> 161, 159, 159, 159, 161, 159, 159, 159, 161, 159, 161, 155,…
## $ X.33       <int> 161, 163, 163, 163, 177, 161, 161, 163, 161, 165, 163, 159,…
...
## $ X.36       <int> 228, 228, 226, 226, 226, 226, 222, 230, 228, 238, 226, 228,…
...
## $ X.45       <int> 304, 304, 306, 306, 308, 304, 306, 306, 306, 306, 306, 318,…
...
##  2   132   132   132   132   141   155   157    NA   246   248   250    NA   218
##  3   132   132   132   132   141   146   157    NA   244   246   248    NA   218
##  4   132   132   132   132   146   151   155    NA   244   248   250   256   216
##  5   132   132   132   132   141   146    NA    NA   246   246   246   246   218
##  6   132   134    NA    NA   141   155    NA    NA   244   246   262    NA   216
##  7   128   132   166    NA   141   148   155    NA   244   246   250    NA   218
##  8   132   132   132   132   141   148   155    NA   246   248    NA    NA   216
##  9   134   135    NA    NA   151   159    NA    NA   250   250    NA    NA   216
## 10   126   132    NA    NA   148   155   171    NA   246   246   246   246   218
## # ℹ 266 more rows
## # ℹ 51 more variables: X.9 <int>, X.10 <int>, X.11 <int>, AG13 <int>,
## #   X.12 <int>, X.13 <int>, X.14 <int>, AG23 <int>, X.15 <int>, X.16 <int>,
## #   X.17 <int>, AG25 <int>, X.18 <int>, X.19 <int>, X.20 <int>, AG27 <int>,
## #   X.21 <int>, X.22 <int>, X.23 <int>, AG30 <int>, X.24 <int>, X.25 <int>,
## #   X.26 <int>, AG35 <int>, X.27 <int>, X.28 <int>, X.29 <int>, A2 <int>,
## #   X.30 <int>, X.31 <int>, X.32 <int>, A22 <int>, X.33 <int>, X.34 <int>, …
```
...
##  2   146   159   254   218   268   360    93   101   107   202   142   161   228
##  3    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA
##  4    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA    NA
##  5   132   141   246   218   251   356    93   101    97   184   142   159   224
##  6   132   155   248   218   266   356   105   103    99   200   142   163   228
##  7   132   157   250   218   270   356    NA   105   103    NA   142   167   230
##  8   132    NA    NA   218   272   356    NA    NA    NA    NA   142   169    NA
##  9   132   141   244   218   262   356    93   101    97   181   142   159   224
## 10   132   146   246   218   266   358    99   103    99   186   142   163   226
## # ℹ 1,094 more rows
...
##  6 T-482  Madres     4x        132   155   248   218   266   356   105   103
##  7 T-482  Madres     4x        132   157   250   218   270   356    NA   105
##  8 T-482  Madres     4x        132    NA    NA   218   272   356    NA    NA
##  9 T-483  Madres     4x        132   141   244   218   262   356    93   101
## 10 T-483  Madres     4x        132   146   246   218   266   358    99   103
## # ℹ 1,094 more rows
...
```r
# Encode 'sample' and 'population' as factors with numeric labels
res <- mydat %>% 
  ungroup() %>% 
  mutate(sample = as.integer(forcats::fct_inorder(factor(sample))), 
         population = as.integer(forcats::fct_inorder(factor(population)))) %>% 
  select(-3)
